        ...
        <div className="flex items-center space-x-3 text-[11px]">
          ...
          <label className="flex items-center space-x-1.5 cursor-pointer text-slate-300 hover:text-white">
            <input
              ...
              onChange={(e) =>
                setLayerVisibility((prev) => ({ ...prev, traffic: e.target.checked }))
              }
              ...
              <div className="absolute bottom-3 left-3 p-3 bg-[#090b0e]/95 border border-slate-800 backdrop-blur text-[10px] font-mono space-y-2 z-10 shadow-xl max-w-sm">
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-x-3 gap-y-1 mt-1.5 text-slate-300">
                    ...
                    {/* Mapbox Live Traffic Congestion */}
                    {layerVisibility.traffic && (
                      <div className="col-span-2 pt-1 border-t border-slate-800 space-y-1">
                        <div className="text-[9px] uppercase font-bold text-emerald-400 flex items-center">
                          <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 mr-1 animate-pulse" /> Mapbox Live Traffic
                        </div>
                        <div className="grid grid-cols-4 gap-1 text-[9px]">
                          <span className="flex items-center text-emerald-400 font-bold">
                            <span className="w-2.5 h-1.5 bg-[#20c85a] mr-1 rounded-sm" /> Low
                          </span>
                          <span className="flex items-center text-yellow-400 font-bold">
                            <span className="w-2.5 h-1.5 bg-[#ffd400] mr-1 rounded-sm" /> Moderate
                          </span>
                          <span className="flex items-center text-orange-400 font-bold">
                            <span className="w-2.5 h-1.5 bg-[#ff8c00] mr-1 rounded-sm" /> Heavy
                          </span>
                          <span className="flex items-center text-red-400 font-bold">
                            <span className="w-2.5 h-1.5 bg-[#e53935] mr-1 rounded-sm" /> Severe
                          </span>
                        </div>
                      </div>
                    )}
