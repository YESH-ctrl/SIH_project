...
export function getAdminDashboardData(): AdminDashboardData {
  return {
    ...
    roleDistribution: [
      { role: "Operations Managers", count: 4, color: "#38bdf8" },
      { role: "Dispatchers", count: 12, color: "#a855f7" },
      { role: "Analysts", count: 5, color: "#f59e0b" },
      { role: "Org Admins", count: 2, color: "#10b981" },
    ],
